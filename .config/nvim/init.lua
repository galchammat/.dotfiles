...
require('lazy').setup({
  ...
  { import = 'plugins' }, -- Import additional plugins from the `plugins/` directory
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>vp', function()
        local name = vim.fn.input 'Plugin file: '
        if name == '' then
          return
        end
        ...
        gopls = {
          settings = {
            gopls = {
              ...
              staticcheck = true,
              gofumpt = true,
              -- Enable deep completion to find symbols across modules
              deepCompletion = true,
              -- Ensure gopls indexes the entire workspace including dependencies
